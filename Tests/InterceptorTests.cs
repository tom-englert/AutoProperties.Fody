...
namespace Tests
{
    public class InterceptorTests
    {
        ...
        public InterceptorTests(ITestOutputHelper testOutputHelper)
        {
        ...
        public void SimpleInterceptorTest(string className, int expectedNumberOfFields, string? property3Value = null)
        {
        ...
        public void WithBackingFieldAccessTest(string className, int expectedNumberOfFields, string? property3Value = null)
        {
            var target = _assembly.GetInstance(className);
        ...
        public void BadImplementationInterceptorTest(string className, int expectedNumberOfFields)
        {
            var target = _assembly.GetInstance(className);
        ...
        public void SubClassWithPropertyOverrideTest(string className)
        {
            var target = _assembly.GetInstance(className);
        }
        ...
        public void ClassWithAutoPropertyInitAndGenericBaseTest(string className)
        {
            var target = _assembly.GetInstance(className);
            target.Prop1 = 42;
        ...
        public void GenericBaseClassOfInt_Test(string className)
        {
        ...
        public void GenericBaseClassOfString_Test(string className)
        {
            var parent = _assembly.GetInstance(className);
        ...
        public void SomeClassWithoutGenerics_Test(string className)
        {
            var parent = _assembly.GetInstance(className);
